...
if __name__ == '__main__':
    ...
    if load_data == True:
        ...
        test_plays = load_npz('data/test_sparse.npz')
        song_df = pd.read_hdf('data/song_df.h5', key='df')
        song_df_sparse_indexed = song_df[['song_id', 'sparse_index']].set_index('sparse_index')
    ...
    yolo = get_metrics(metric,N,baseline_cf_model,train_plays,test_plays,song_df_sparse_indexed)
