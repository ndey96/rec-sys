...
class AlternatingLeastSquaresDiversity(AlternatingLeastSquares):
    ...
    def __init__(self,
        ...
        super().__init__(factors, regularization, dtype, use_native, use_cg,
                         use_gpu, iterations, calculate_training_loss,
                         num_threads)
    ...
    def recommend(self,
        ...
        recs = super().recommend(userid, user_items, N,
                                 filter_already_liked_items, filter_items,
                                 recalculate_user)
